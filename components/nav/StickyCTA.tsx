...
export default function StickyCTA() {
  return (
    <div className="md:hidden fixed left-3 right-3 bottom-3 z-50 bg-navy text-white rounded-2xl px-4 py-3 shadow-2xl shadow-black/30 flex items-center justify-between gap-3 print:hidden">
      <div>
